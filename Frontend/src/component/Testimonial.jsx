...
const Testimonial = () => {
  ...
  const renderStars = (rating) =>
    Array.from({ length: 5 }, (_, i) => (
      <span key={i} className={i < rating ? t.activeStar : t.inactiveStar}>
    ...
    <div className={t.container}>
      <div className={t.headerContainer}>
        ...
        <p className={t.subtitle}>
          Real stories from doctors and patients sahring there positive
          Experiences
        </p>
      </div>
      ...
      >
        ...
        <div className={`${t.columnContainer} ${t.rightCardBorder}`}>
