...
export const bannerStyles = {
  ...
  bannerContainer: "relative w-full max-w-7xl mx-auto mt-28 mb-12 px-4",
...
export const doctorsPageStyles = {
  // Main container
  mainContainer: "min-h-screen bg-linear-to-br from-emerald-50 to-teal-100 pt-20 pb-8 sm:pt-24 sm:pb-10 px-3 sm:px-6 relative overflow-hidden",
...
export const footerStyles = {
  ...
  logoImageContainer: "relative w-16 h-16 md:w-20 md:h-20 lg:w-20 lg:h-20 p-1 transform transition-transform duration-500",
  logoImage: "w-full h-full object-contain",
  companyName: "text-xl md:text-2xl lg:text-3xl font-bold bg-linear-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent font-['Poppins'] tracking-tight",
...
export const navbarStyles = {
  ...
  logoImage: "w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 xl:w-24 xl:h-24 md:w-16 md:h-16 object-contain",
  logoTextContainer: "block sm:block",
  logoTitle: "text-xl md:text-2xl lg:text-3xl xl:text-3xl font-bold bg-clip-text text-transparent bg-linear-to-r from-emerald-600 to-green-600 tracking-tight",
  logoSubtitle: "text-xs lg:text-xs text-gray-500",
  
  // Desktop navigation
  desktopNav: "hidden lg:-mx-5 lg:flex items-center gap-2",
  navItemsContainer: "flex gap-[24px] bg-white border border-emerald-200 p-1 rounded-full shadow-lg",
...
export const servicePageStyles = {
  // Page container
  pageContainer: "min-h-screen pt-20 py-12 px-6 lg:px-20 font-serif bg-linear-to-b from-emerald-50 to-white",
  maxWidthContainer: "max-w-6xl mx-auto",
