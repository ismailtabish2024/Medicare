...
// Appointment page styles (for AppointmentsPage.jsx)
export const appointmentPageStyles = {
  pageContainer: "min-h-screen bg-linear-to-br from-emerald-100 via-white to-emerald-50 pt-24 pb-12 px-4 sm:px-6 md:px-8 lg:px-20 font-serif relative overflow-hidden",
  maxWidthContainer: "max-w-6xl mx-auto",
  doctorTitle: "text-3xl md:text-4xl font-extrabold text-emerald-800 mb-8 text-center",
  serviceTitle: "text-2xl md:text-3xl font-bold text-emerald-800 mt-12 mb-6 text-center",
  loadingText: "text-center text-emerald-600 py-8",
  emptyStateText: "text-center text-emerald-500 py-8",
  serviceLoadingText: "text-center text-emerald-600 py-8",
  serviceEmptyStateText: "text-center text-emerald-500 py-8",
  doctorGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12",
  serviceGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
};
...
export const cardStyles = {
  ...
  serviceCard: "bg-white border border-blue-200 rounded-2xl p-6 shadow-md hover:shadow-blue-300 transform hover:-translate-y-2 transition-all duration-300 flex flex-col items-center",
  doctorImageContainer: "w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-emerald-100",
  serviceImageContainer: "w-24 h-24 rounded-full overflow-hidden mb-4 border-4 border-blue-100",
  image: "w-full h-full object-cover",
  doctorName: "text-xl font-bold text-emerald-800 mb-2 text-center",
  serviceName: "text-xl font-bold text-blue-800 mb-2 text-center",
  specialization: "text-sm text-emerald-600 mb-4 text-center",
  dateContainer: "flex items-center gap-2 text-emerald-700 mb-2",
  timeContainer: "flex items-center gap-2 text-emerald-700 mb-4",
  serviceDateContainer: "flex items-center gap-2 text-blue-700 mb-2",
  serviceTimeContainer: "flex items-center gap-2 text-blue-700 mb-4",
  price: "text-lg font-semibold text-blue-700 mb-4",
  badgesContainer: "flex flex-wrap gap-2 justify-center mb-4",
  rescheduledText: "text-sm text-amber-600 text-center mt-2",
  serviceRescheduledText: "text-sm text-amber-600 text-center mt-2",
...
export const badgeStyles = {
  ...
  statusBadge: {
    completed: "px-3 py-1 rounded-full font-semibold text-xs bg-emerald-100 text-emerald-700 border border-emerald-300 flex items-center gap-1",
    confirmed: "px-3 py-1 rounded-full font-semibold text-xs bg-blue-100 text-blue-700 border border-blue-300 flex items-center gap-1",
    pending: "px-3 py-1 rounded-full font-semibold text-xs bg-amber-100 text-amber-700 border border-amber-300 flex items-center gap-1",
    canceled: "px-3 py-1 rounded-full font-semibold text-xs bg-rose-100 text-rose-700 border border-rose-300 flex items-center gap-1",
    default: "px-3 py-1 rounded-full font-semibold text-xs bg-gray-100 text-gray-700 border border-gray-300 flex items-center gap-1"
  }
};
